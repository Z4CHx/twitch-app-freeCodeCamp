    ...
    channelList.forEach(function(channel){
        ...
        success: function(data){
            if(channels.hasOwnProperty(channel)) {
                ...
                var channelRow = '<div id="' + data.display_name +'" class="row"><div class="container-fluid channel"><div class="panel-body"><div class="channel-logo col-md-4"><a href ="' + data.url + '"><img src="' + data.logo + '"></a></div>' + '<div class="channel-id col-md-4"><a href="' + data.url + '">' + data.display_name + '</a></div><div class="stream-status col-md-4">' + statusPhrase() + '</div></div></div></div>';
